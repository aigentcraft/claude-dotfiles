...
$NewContent.Add('## All Nodes Index (nodes/)')
$NewContent.Add('')
$NewContent.Add('> Complete index below. Use clusters for structured entry.')
$NewContent.Add('')
...
$NewContent.Add('---')
$NewContent.Add('')
$NewContent.Add('*Note: This index is auto-generated by scripts/generate-moc.*')
