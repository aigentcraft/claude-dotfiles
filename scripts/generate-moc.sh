...
# Append the header
echo -e "## All Nodes Index (nodes/)\n" >> "$TEMP_FILE"
echo -e "> Complete index below. Use clusters for structured entry.\n" >> "$TEMP_FILE"
...
echo -e "\n---\n" >> "$TEMP_FILE"
echo -e "*Note: This index is auto-generated by scripts/generate-moc.*" >> "$TEMP_FILE"
